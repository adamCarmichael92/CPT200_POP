...
public class Main extends Application {
	...
	Button totalCost = new Button("Calculate Total");
	...
	CheckBox topping1 = new CheckBox("Pepperoni - $1.50");
	CheckBox topping2 = new CheckBox("Green Pep - $1.50");
	CheckBox topping3 = new CheckBox("Sausage - $1.50");
	CheckBox topping4 = new CheckBox("Bacon - $1.50");
	...
	CheckBox side1 = new CheckBox("Garlic Knots - $5.50");
	CheckBox side2 = new CheckBox("Hot Wings - $8.00");
	CheckBox side3 = new CheckBox("Cheese Bread - $5.50");
	CheckBox side4 = new CheckBox("Salad - $6.50");
	...
	CheckBox drink1 = new CheckBox("Coke-Cola - $2.00");
	CheckBox drink2 = new CheckBox("Sprite - $2.00");
	CheckBox drink3 = new CheckBox("Mountain Dew - $2.00");
	CheckBox drink4 = new CheckBox("Diet Coke - $2.00");
	...
	GridPane.setConstraints(totalCost, 0, 3);
	GridPane.setConstraints(total, 1, 3);
	
	layout6.getChildren().addAll(select, carryOut, delivery, totalCost, total);
	...
	Button totalCalced = new Button("Calculate Total");
	TextField calcedTotal = new TextField();
	...
	GridPane.setConstraints(totalCalced, 0, 6);
	GridPane.setConstraints(calcedTotal, 1 , 6);
	...
	kitchenLayout.getChildren().addAll(order, prep, cooking, box, outTheDoor, track, totalCalced, calcedTotal);
	...
	totalCost.setOnAction(e -> total.setText(Order.printToTotal(sizeSmall, sizeMed, sizeLarge, topping1, topping2, topping3, topping4, side1, side2, side3, side4, drink1, drink2, drink3, drink4)));
	
	totalCalced.setOnAction(e -> calcedTotal.setText(Order.printToTotal(sizeSmall, sizeMed, sizeLarge, topping1, topping2, topping3, topping4, side1, side2, side3, side4, drink1, drink2, drink3, drink4)));
	...
	if(sizeSmall.isSelected()) { message += "10 - $6.99\" "; }
	if(sizeMed.isSelected()) { message += "12 - $8.99\" "; }
	if(sizeLarge.isSelected()) { message += "14  - $10.99\" "; }
